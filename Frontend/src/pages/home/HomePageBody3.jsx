...
export const HomePageBody3 = () => {
  return (
    <section className="kgall sec k-sec">
    <div className="all">

        <div className="kgall-wrap">
            <div className="kgall-top">
                ...
                <div className="kgall-btn">
                    <a href="https://adongsilk.com/gallery/" className="btn primary-btn">View detail </a>
                </div>
            </div>
            <div className="kgall-main">
                <div className="kgall-list">
                    <div className="kgall-item">
    <a href="https://adongsilk.com/gallery-detail/tailored-wedding-suits-01/" className="kgall-box">
...
<div className="kgall-item">
    <a href="https://adongsilk.com/gallery-detail/tailored_wedding_suits/" className="kgall-box">
        <span className="kgall-img">
            <img 
                width="1310" 
                height="861" 
...
<div className="kgall-item">
    <a href="https://adongsilk.com/gallery-detail/tailored-wedding-suits/" className="kgall-box">
        <span className="kgall-img">
            <img 
                width="683" 
                height="1024" 
...
<div className="kgall-item">
    <a href="https://adongsilk.com/gallery-detail/online_tailored_wedding_suits_01/" className="kgall-box">
        <span className="kgall-img">
            <img 
                width="2560" 
                height="1706" 
...
<div className="kgall-item">
    <a href="https://adongsilk.com/gallery-detail/tailored-wedding-suits_05/" className="kgall-box">
        <span className="kgall-img">
            <img 
                width="1440" 
                height="1800" 
...
<div className="kgall-item">
    <a href="https://adongsilk.com/gallery-detail/linen-wedding-suits-in-hoi-an/" className="kgall-box">
        <span className="kgall-img">
            <img 
                width="1280" 
                height="852" 
...
<div className="kgall-item">
    <a href="https://adongsilk.com/gallery-detail/wedding-suit/" className="kgall-box">
        <span className="kgall-img">
            <img 
                width="861" 
                height="1289" 
...
<div className="kgall-item">
    <a href="https://adongsilk.com/gallery-detail/tailored-wedding-suits-in-hoi-an-2/" className="kgall-box">
        <span className="kgall-img">
            <img 
                width="640" 
                height="800" 
...
<div className="kgall-item">
    <a href="https://adongsilk.com/gallery-detail/tailored-wedding-suit-dress-in-hoi-an/" className="kgall-box">
        <span className="kgall-img">
            <img 
                width="1080" 
                height="1080" 
...
<div className="kgall-item">
    <a href="https://adongsilk.com/gallery-detail/wedding-dress-ms06/" className="kgall-box">
        <span className="kgall-img">
            <img 
                width="235" 
                height="245" 
...
<div className="kgall-item">
    <a href="https://adongsilk.com/gallery-detail/online-wedding-suits-02/" className="kgall-box">
        <span className="kgall-img">
            <img 
                width="2560" 
                height="1706" 
        ...
        <span className="kgall-desc">
            Online Wedding Suits
        </span>
    </a>
</div>

<div className="kgall-item">
    <a href="https://adongsilk.com/gallery-detail/wedding-dress-ms04/" className="kgall-box">
        <span className="kgall-img">
            <img 
                width="230" 
                height="243" 
...
<div className="kgall-item">
    <a href="https://adongsilk.com/gallery-detail/wedding-dress-ms02/" className="kgall-box">
        <span className="kgall-img">
            <img 
                width="193" 
                height="243" 
...
<div className="kgall-item">
    <a href="https://adongsilk.com/gallery-detail/tailored-wedding-suits-in-hoi-an/" className="kgall-box">
        <span className="kgall-img">
            <img 
                width="2560" 
                height="1708" 
...
<div className="kgall-item">
    <a href="https://adongsilk.com/gallery-detail/tailored-wedding-suits-08/" className="kgall-box">
        <span className="kgall-img">
            <img 
                width="1440" 
                height="1800" 
